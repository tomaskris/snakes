...
//
//    public GameBoard(BufferStrategy bs) {
...
//        this.foodManager = new FoodManager((Graphics2D) bs.getDrawGraphics());//g2);
//        gameInit();
//    }
//
//    /**
...
//            inGame = false;
//        } else if (foodManager.checkCollision(snake)) {
//            snake.expandBody();
//        } else {
//            snake.move();
//        }
...
//        g2.setFont(font);
//        g2.drawString(zprava, (MAX_WIDTH_GAME_BOARD - metr.stringWidth(zprava)) / 2, (MAX_HEIGHT_GAME_BOARD / 2) + 25);
//        g2.drawString(skore, (MAX_WIDTH_GAME_BOARD - metr.stringWidth(skore)) / 2, (MAX_HEIGHT_GAME_BOARD / 2) - 25);
//
//        g2.dispose();
//
//        bs.show();
...
//
//    /**
//     * Sukromna trieda, ktera spracuvava stlacene klavesy
//     */
